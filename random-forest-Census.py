...
melhores = []
while contador <= 40:
 previsores_training,previsores_test,classe_training,classe_test=train_test_split(previsores, classe, test_size = 0.15, random_state = 0)
 # Com a base de dados faz treinamento e teste
 from sklearn.ensemble import RandomForestClassifier
 classificador = RandomForestClassifier(n_estimators=int(contador),criterion='entropy',random_state=0)
 ...
 if accuracy_score(classe_test, preview) >= 0.84:
